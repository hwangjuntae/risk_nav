...
launch_args = [
    ...
    DeclareLaunchArgument('install_path', default_value='/home/usr/isaac-sim', description='If Isaac Sim is insalled in a non-default location, provide a specific path to Isaac Sim installation root folder. (If defined, "version" parameter will be ignored)'),
    ...
    DeclareLaunchArgument('gui', default_value='/home/usr/ws/src/jackal_nav/usd/office.usd', description='Provide the path to a usd file to open it when starting Isaac Sim in standard gui mode. If left empty, Isaac Sim will open an empty stage in standard gui mode.'),
